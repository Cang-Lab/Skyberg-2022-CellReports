...
function Finding_Responsive_SUs_RG(Mouse, Section)

Load_FilePath = ['G:\Science\MountainSort\' Mouse '\' Mouse '_Section_' num2str(Section) '\' Mouse '_Section_' num2str(Section)]; % File path to load data from

Save_FilePath = ['G:\Science\MountainSort\' Mouse '\' Mouse '_Section_' num2str(Section) '\Processed Data\' Mouse '_Section_' num2str(Section)]; %file path to save processed data too
